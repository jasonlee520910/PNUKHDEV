...
<body>
<link type="text/css" rel="stylesheet" href="<?=$postal?>/postal.css?v=<?php echo time();?>" />
...
<h1><?=$txtdt["1479"]?><!-- 우편번호검색 --><span class="closebtn" onclick="closediv('viewlayer')"><?=$txtdt["1595"]?><!-- 닫기 --></span></h1>
<ul id="zipdiv" class="zipdiv">
	<li class="search"><input type="text" name="keyword" id="keyword" value="" class="postaldown"><span class="btn postalbtn"><?=$txtdt["1499"]?><!-- 찾기 --></span><p><?=$txtdt["1500"]?><!-- 도로명, 건물명, 지번에 대해 통합검색이 가능합니다.(예: 반포대로 58, 국립중앙박물관, 삼성동 25) --></p></li>
