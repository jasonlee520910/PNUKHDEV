...
?>
<style>
#tbllist .txt_line {overflow : hidden;text-overflow : ellipsis;height : 20px;display : -webkit-box;}
</style>
...
<input type="hidden" name="returnData" class="reqdata" value="<?=$root?>/Skin/Board/Policy.php">
...
<div class="board-list-wrap">
	...
	<table id="tbllist" class="tblcss">
		  ...
		  <thead>
			 <tr>
				<th>그룹날짜</th>
				<th class='left' style='padding-left:10px;'>제목</th>
			  </tr>
		  </thead>
		  <tbody>
	...
	function makepage(json)
	{
		...
		{			
			...
			if(!isEmpty(obj["list"]))
			{
				...
				{
					data+="<tr style='cursor:pointer;' onclick=\"viewdesc('"+value["poGroup"]+"')\">";
					data+="<td>"+value["poGroup"]+"</td>"; //그룹날짜 
					data+="<td class='left'>개인정보처리방침</td>";//제목
					data+="</tr>";				
				});
			}
			else
