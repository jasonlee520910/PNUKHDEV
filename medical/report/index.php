...
<script>
	function tbmsurl()
	{
		var url="https://tbms.pnukh.or.kr/";  //DEV 
		return url;
	}
	...
	function callopenapi(type,group,code,data)
	{
		...
		console.log("callopenapi url : "+url);
	...
	function makepage(json)
	{
		...
		if(obj["apiCode"]=="orderreport")
		{
			...
			var title = obj["miName"]+' - 품질보고서';  //9047 품질보고서
...
*/
			...
			{		
				...
				{		
					...
					data+="<tr>";
					data+="<td class='l'>"+"<img src='<?=$root?>/noimg.png'>"+"</td>"; 
