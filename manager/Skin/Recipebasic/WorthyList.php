...
<div id="pagecode" value="worthylist"></div>
...
<!-- s : 게시판 페이징 -->
<div class='' id="worthylistpage"></div>
<!-- e : 게시판 페이징 -->
...
<script>
	...
	function makepage(json)
	{
		...
		if(obj["apiCode"]=="worthylist")
		{
			...
			//페이지
			getsubpage("worthylistpage",obj["tpage"], obj["page"], obj["block"], obj["psize"]);
		}
		return false;
	}
	...
	callapi('GET','recipe','worthylist',apidata);  
	$("#searchTxt").focus();
</script>
