<?php
	...
	$userid="2978496621"; //세명대ID

	if($apiCode!="ordersweekly"){$json["resultMessage"]="API(apiCode) ERROR";$apiCode="ordersweekly";}
	else if(!($language=="kor"||$language=="chn"||$language=="eng")){$json["resultMessage"]="API(language) ERROR";}
	else
	{

		$sql=" select  ";
		$sql.=" to_char(a.od_date, 'd') AS week_n,  ";
		...
		$sql.=" GROUP BY to_char(a.od_date, 'd'),to_char(a.od_date, 'dy') ";
		$sql.=" order by to_char(a.od_date, 'd') asc ";
