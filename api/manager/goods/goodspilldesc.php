<?php
	...
	if($apiCode!="goodspilldesc"){$json["resultMessage"]="API(apiCode) ERROR";$apiCode="goodspilldesc";}
	...
	else
	{
		...
		///------------------------------------------------------------
		$hCodeList = getNewCodeTitle("dcTitle,mrDesc,reDelitype,dcShape,dcBinders,dcFineness,dcJungtang,dcRipen,reSendType,meSex,mhFeature,patientType");
		///------------------------------------------------------------
...
<?php 
	function getPillMatype()
	{
		...
		$wsql=" where cd_use <> 'D' and cd_type='maType' and cd_code='pill' ";
		$sql=" select ";
