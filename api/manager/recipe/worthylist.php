<?php  
	...
	if($apicode!="worthylist"){$json["resultMessage"]="API(apiCode) ERROR_uniquesclist";$apicode="worthylist";}
	...
	else
	{
		...
		$wsql=" where a.rc_use in ('F','Y') and  a.rc_medical='worthy' ";  ///worthy 실속처방
		...
		while($dt=dbarr($res))
		{
			...
			$addarray = array(
				...
				"rcPackCapa"=>$dt["RCPACKCAPA"], ///팩용량
				"rcPackType"=>$dt["PACKTYPE"],  ///파우치
				"rcMediBox"=>$dt["MEDIBOX"],  ///한약박스
