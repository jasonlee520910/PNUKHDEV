...
function radioClick(obj)
{
	...
	else if(obj.name=="gdType")  //goods 분류가 원재료일때
	{
		showcode(obj.value);
	}
}
...
function modinput(type,seq,btn)
{
 //console.log("modinput    함수 type   "+type+"    seq:   "+seq+"         btn :"+btn);
	var arr0=arr1=arr2=arr3=arr4=arr5=arr6=arr7=arr8=arr9=read=add=worker=stat=statable=group=table=mdcode=bostatus=bostaff=txttype="";
	type=type.split("_");
