<?php  //release orderlist
	...
	else
	{
		...
		$wsql.=" and (e.re_staffid='' or e.re_staffid is null or e.re_staffid='".$staffid."') ";
		if($depart)
		{
		...
		$osql.=" order by decode(a.od_status,'release_processing',1,'release_start',2,'release_apply',3,'release_stop',4,'release_cancel',5), to_char(a.od_date, 'yyyy-mm-dd hh24:mi:ss') desc ";
