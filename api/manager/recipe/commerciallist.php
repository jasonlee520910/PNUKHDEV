<?php  
	...
	$page=$_GET["page"];
	if($apicode!="commerciallist"){$json["resultMessage"]="API(apiCode) ERROR_uniquesclist";$apicode="commerciallist";}
	...
	else
	{
		...
		$wsql=" where a.rc_use in ('F','Y') and  a.rc_medical='commercial' ";  //상비 commercial
