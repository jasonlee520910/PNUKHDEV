    ...
    <div class="sub join-fill-in">
        <div class="sub__content">
            ...
            <div class="btnBox btnBox--modify d-flex">
                <a href="javascript:;" class="d-flex btn bg-white border-blue color-blue radius" onclick="viewdesc('');return false;">이전</a>
                <a href="javascript:joinfillin_update('hold');" class="d-flex btn color-white bg-blue radius">완료</a>
                <a href="javascript:joinfillin_update('');" class="d-flex btn color-white bg-blue radius">다음에 한의원 등록</a>
            </div>
        </div>
    </div>
</div>
