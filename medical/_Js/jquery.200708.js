	...
	*/
		...
		if(json["resultCode"]=="200")
		{
			...
			$.each(json["list"] ,function(index, val){
				...
				for(i=0;i<marr.length;i++)
				{
					...
					else if(marr[i]=="ordertype" || marr[i]=="rcType" ||  marr[i]=="rcMedicineCnt")
					{
						var txt=val[marr[i]];
						cls="td-txtcenter";
					}
					...
					else if(marr[i]=="ordertitle")
					{
						...
						//{
							...
							{
								txt+="<span style='padding-top:3px;display:block;text-decoration:normal;font-size:12px;color:gray;width:420px;overflow:hidden; text-overflow:ellipsis; white-space:nowrap;'>"+val["totmediname"]+"</span>";
							}
							txt+="</div>";
					...
					else if(marr[i]=="mychkbox")
					{
						txt="<div class='inp-checkBox'>";
						txt+="	<div class='inp inp-check d-flex'>";
						txt+="		<label for='myid"+val["seq"]+"' class='d-flex'>";
						txt+="			<input type='checkbox' name='mycb"+val["seq"]+"' id='myid"+val["seq"]+"' class='cblind' data-rcseq='"+val["rc_seq"]+"'>";
						txt+="			<span></span>";
						txt+="		</label>";
						txt+="	</div>";
						txt+="</div>";
					...
					else if(marr[i]=="mychkboxdel")
					{
						txt="<div class='inp-checkBox'>";
						txt+="	<div class='inp inp-check d-flex'>";
						txt+="		<label for='mydelid"+val["seq"]+"' class='d-flex'>";
						txt+="			<input type='checkbox' name='mydelcb"+val["seq"]+"' id='mydelid"+val["seq"]+"' class='cblind' data-seq='"+val["seq"]+"'>";
						txt+="			<span></span>";
						txt+="		</label>";
						txt+="	</div>";
						txt+="</div>";
					...
					else if(marr[i]=="orderstatus") 
					{
						...
						if(val[marr[i]]=="주문완료")
						{
							txt+="<a href='javascript:;' class='btn color-white radius' style='font-size:12px;padding:3px 5px;background:#8FCFBD;'>"+val[marr[i]]+"</a>";
						}
						else
						{
					...
					{
						data+="<td class='td-txtLeft "+cls+"' title='"+val["totmediname"]+"' style='padding:0;'>"+txt+"</td>";
					}
					else
					{
	...
	function getdata(apiCode)
	{
		...
		console.log("getdata  searchTxt >>>"+searchTxt);
