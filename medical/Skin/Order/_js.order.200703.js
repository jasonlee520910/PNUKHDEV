			...
			switch(json["apiCode"]){
				...
				/* case "getpacking":
				 ...
				 case "orderregist":
					...
					console.log("seq    >>>  "+seq+", keycode = "+keycode+",    jsonData = " + jsonData);
...
/*
	...
	*/
	...
	function addmeditbl(json){
		...
		var txt="<tr>";
				...
				*/
				...
				txt+="<input type='text' name='capa' placeholder='' value='"+mediCapa+"' onkeyup='resetCnt()' onfocus='this.select();' onchange='onlynumber(event, true);' maxlength='6'>";
				txt+="</div>";
				txt+="<span>g</span>";
				txt+="</div>";
				txt+="</td>";
	...
	function resetCnt(){
		...
		{
			swtotprice=parseInt(sweetprice)*parseInt(sweetcapa);
			$("#idSweet").show();
