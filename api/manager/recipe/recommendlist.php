<?php  
	...
	$page=$_GET["page"];
	if($apicode!="recommendlist"){$json["resultMessage"]="API(apiCode) ERROR_uniquesclist";$apicode="recommendlist";}
	...
	else
	{
		...
		$jsql.="a left join ".$dbH."_staff s on a.RC_USERID=s.ST_STAFFID ";
		$wsql=" where a.rc_use in ('F','Y') and  a.rc_medical='recommend' ";  //추천처방만  
